...
#cadastro do tipo do dispositivo
...
class Equipamento(models.Model):
    ...
    #fresponsavel = models.ForeignKey(Responsavel, on_delete=models.CASCADE, null=True,blank=True)
...
class Responsavel(models.Model):
    ...
    telefone_celular = models.CharField(max_length=15, verbose_name='Telefone', blank=True)
    data_entrega = models.DateTimeField(default=timezone.now, verbose_name='Data de cadastro')
...
class Devolucao(models.Model):
    ...
    descricao = models.TextField(blank=True, verbose_name='Descrição')
    data_devolucao = models.DateTimeField(default=timezone.now, verbose_name='Data de Devolução')
...
class Manutencao(models.Model):
    ...
    descricao = models.TextField(blank=True, verbose_name='Descrição')
    data_manutencao = models.DateTimeField(default=timezone.now, verbose_name='Data de Manutenção')
