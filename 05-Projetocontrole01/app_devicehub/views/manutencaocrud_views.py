...
from app_devicehub.forms import ManutencaoForm
...
def novo_cadastro_manutencao(request):
    form_action = reverse('app_devicehub:novo_cadastro_manutencao')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
           ...
           return redirect('app_devicehub:atualizar_manutencao', manutencao_id=manutencao.pk)
...
def atualizar_manutencao(request, manutencao_id):
    ...
    form_action = reverse('app_devicehub:atualizar_manutencao', args=(manutencao_id,))
...
def excluir_manutencao(request, manutencao_id):
    ...
    return redirect('app_devicehub:manutencao')