function openDashboard(url){
    ...
    .then(jsonData => {
        ...
        function drawChart() {
            ...
            document.getElementById('ValorLiberado').innerHTML = formatter.format(0) /* formatter.format(valorLiberado) */
            document.getElementById('PesoSeparacao').innerHTML = formatter.format(pesoSeparacao)
            document.getElementById('ValorSeparacao').innerHTML = formatter.format(0) /* formatter.format(valorSeparacao) */
