# Generated by Django 4.2.8 on 2024-04-25 18:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipamento_responsavel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.equipamento', verbose_name='Dispositivo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
                ('data_manutencao', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Data de cadastro')),
                ('equipamento_manutencao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.equipamento', verbose_name='Equipamento em manutenção')),
                ('responsavel_manutencao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.responsavel', verbose_name='Responsável pelo equipamento')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tipo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.tipo'),
        ),
        migrations.CreateModel(
            name='Devolucao',
            fields=[
                ...
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
                ('data_devolucao', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Data de cadastro')),
                ('ultimo_equipamento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.equipamento', verbose_name='Antigo dispositivo')),
                ('ultimo_responsavel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appcd.responsavel', verbose_name='Antigo responsável')),
            ],
            options={
